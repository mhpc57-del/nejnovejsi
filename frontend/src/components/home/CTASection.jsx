    ...
    <div className="max-w-7xl mx-auto">
      <div className="bg-zinc-900 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="relative z-10">
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tighter text-white" style={{ fontFamily: 'Outfit' }}>
            Připraveni začít?
          </motion.h2>
          <motion.p variants={fadeUp} custom={1} className="text-lg text-zinc-400 mt-6 mb-12 max-w-md mx-auto leading-relaxed">
