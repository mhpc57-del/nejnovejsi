    ...
    <div className="max-w-5xl mx-auto">
      ...
      <motion.div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
        ...
        <motion.div variants={fadeUp} custom={1}
          className="bg-zinc-900 rounded-2xl border border-zinc-800 flex flex-col relative overflow-hidden ring-2 ring-orange-500/50 shadow-[0_0_40px_rgba(249,115,22,0.15)]" data-testid="pricing-card-supplier">
          ...
          <div className="p-8 pb-6">
            ...
            <p className="text-sm text-zinc-400 mt-2">Jednorázová platba na 1 měsíc</p>
            <div className="mt-4 flex items-baseline gap-2">
              <span className="text-5xl lg:text-6xl font-black text-orange-500 tracking-tighter" style={{ fontFamily: 'Outfit' }}>190</span>
              <span className="text-xl text-zinc-500 font-medium">Kč</span>
            </div>
          </div>
          <div className="p-8 pt-4 border-t border-zinc-800 flex-1">
            <span className="text-xs font-bold text-zinc-500 tracking-[0.2em] uppercase">Dodavatel</span>
            <p className="text-sm text-zinc-400 mt-2">Jednorázová platba na celý rok</p>
            <div className="mt-4 flex items-baseline gap-2">
