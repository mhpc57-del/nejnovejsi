          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
            ...
            <div className="mt-5 flex items-center gap-3">
              <button onClick={async () => {
                ...
                className={`w-12 h-7 rounded-full transition-colors duration-200 flex items-center px-1 cursor-pointer ${profileForm.sms_notifications ? 'bg-orange-500' : 'bg-zinc-300 dark:bg-zinc-600'}`}
